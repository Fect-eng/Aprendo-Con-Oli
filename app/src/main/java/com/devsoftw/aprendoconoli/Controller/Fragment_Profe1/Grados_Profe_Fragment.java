...
public class Grados_Profe_Fragment extends Fragment {

    public Grados_Profe_Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_grados__profe_, container, false);
