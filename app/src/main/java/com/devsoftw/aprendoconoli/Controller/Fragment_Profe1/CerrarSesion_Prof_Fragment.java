...
public class CerrarSesion_Prof_Fragment extends Fragment {

    public CerrarSesion_Prof_Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_cerrar_sesion__prof_, container, false);
