...
public class Notioli_Prof_Fragment extends Fragment {

    public Notioli_Prof_Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_notioli__prof_, container, false);
